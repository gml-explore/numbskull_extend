...
class FactorGraph(object):
    ...
    def __init__(self, weight, variable, factor, fmap,alpha_bound,tau_bound,sample_list, vmap,
        ...
        for ep in range(epochs):
            ...
            with Timer() as timer:
                args = (self.threads, stepsize, regularization, reg_param,
                        ...
                        self.variable, self.factor, self.fmap,self.alpha_bound,self.tau_bound,
                        self.sample_list,self.vmap, self.factor_index, self.Z,
                        self.fids,self.var_value, self.var_value_evid,
                        self.weight_value, learn_non_evidence,self.poential_weight)
