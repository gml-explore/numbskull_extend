...
for i in range(len(fg1[1])):
    if fg[1][i]["initialValue"] == fg1[1][i]["initialValue"]:
        flag += 1
    if i < int(len(fg1[1])*0.1):
        print("TrueVarValue:", fg[1][i]["initialValue"], "InferencedVarValue:", fg1[1][i]["initialValue"])
print(".........................................")
print("MatchScore:", flag / len(fg[1]))
