...
class NumbSkull(object):
    ...
    def loadFactorGraph(self, weight, variable, factor, fmap, domain_mask,
                        edges, alpha_bound,tau_bound,sample_list,var_copies=1, weight_copies=1,
        ...
        fg = FactorGraph(weight, variable, factor, fmap,alpha_bound,tau_bound,sample_list, vmap, factor_index,
                         var_copies, weight_copies,
                         len(self.factorGraphs), self.nthreads)
        self.factorGraphs.append(fg)
    ...
    def learning(self, fgID=0, out=False):
        """TODO."""
        # print("当前位置：numbskull.py line 376")
        burn_in = self.burn_in
        ...
        # print("当前位置：numbskull.py line 385")
        ...
        # print("当前位置：numbskull.py line 391")
        if out:
            output_file = os.path.join(
